...
<form method="post" action="../admin/rqnewcusaccept.php">
<input type="hidden" name="pre_customerid" value="<?=$pre_customerid?>" />
  ...
  <tr>
    <td valign="top"><?=T_CUSTNICK;?></td>
    <td valign="top"><input name="pcus_nick" type="text" size="10" maxlength="4" /></td>
    <td valign="top" class="Small"> <strong><?=T_CHOOSEONE;?></strong>      <? 	$prefix = '';
			$count = 0;
			$index = 0;			
  ...
  <tr>
    <td>&nbsp;</td>
    <td><input type="submit" value="<?=T_ACCEPT;?>" /></td>
    <td>&nbsp;</td>
  </tr></form>
</table>
