...
<table cellpadding="0" cellspacing="0" height="100%" width="100%"><tr><td valign="top">
                            <table width="100%" border="0" cellpadding="2" cellspacing="1">
                              ...
                              <tr>
                                <td class="tdRowOnOut" onMouseOver="this.className='tdRowOnOver'" onMouseOut="this.className='tdRowOnOut'" onClick="OpenDivShowPatientInfo('<?=$customer_id?>','<?=$patient_data->Rs("ord_patientname");?>')"  style="padding-left:10px;padding-right:10px">
                                <? if($patient_data->Rs("ord_patientname") == ""){
									echo ("UNNAMED");
								}else{
									echo ($patient_data->Rs("ord_patientname"));
								}
