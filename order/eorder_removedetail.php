...
<? if(!isset($uplotype))$uplotype="Upper";?>
<div id="RemoveDetail<?=$uplotype?>RPD">
  ...
  <tr>
    ...
    <td><table width="200" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td align="center" background="../resource/images/eorder/panel/hd2.gif" bgcolor="#000066" class="TBHead"><?=$uplotype?> : RPD</td>
...
<div id="RemoveDetail<?=$uplotype?>TP">
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="10" height="10" background="../resource/images/eorder/panel/pn1.gif"></td>
    <td height="10" background="../resource/images/eorder/panel/pn2.gif"></td>
  ...
  <tr>
    ...
    <td><table width="200" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="10" height="25" align="center" class="TBHead"><img src="../resource/images/eorder/panel/hd1.gif" width="10" height="25" /></td>
        <td align="center" background="../resource/images/eorder/panel/hd2.gif" bgcolor="#000066" class="TBHead"><?=$uplotype?> : TP</td>
        <td width="11" height="25" align="center" class="TBHead"><img src="../resource/images/eorder/panel/hd3.gif" alt="" width="11" height="25" /></td>
      </tr>
    </table>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
...
<div id="RemoveDetail<?=$uplotype?>Vitaflex">
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="10" height="10" background="../resource/images/eorder/panel/pn1.gif"></td>
    <td height="10" background="../resource/images/eorder/panel/pn2.gif"></td>
  ...
  <tr>
    ...
    <td><table width="200" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="10" height="25" align="center" class="TBHead"><img src="../resource/images/eorder/panel/hd1.gif" width="10" height="25" /></td>
        <td align="center" background="../resource/images/eorder/panel/hd2.gif" bgcolor="#000066" class="TBHead"><?=$uplotype?> : Vitaflex</td>
        <td width="11" height="25" align="center" class="TBHead"><img src="../resource/images/eorder/panel/hd3.gif" alt="" width="11" height="25" /></td>
      </tr>
    </table>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
...
<div id="RemoveDetail<?=$uplotype?>Repair">
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="10" height="10" background="../resource/images/eorder/panel/pn1.gif"></td>
    <td height="10" background="../resource/images/eorder/panel/pn2.gif"></td>
  ...
  <tr>
    ...
    <td><table width="200" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="10" height="25" align="center" class="TBHead"><img src="../resource/images/eorder/panel/hd1.gif" width="10" height="25" /></td>
        <td align="center" background="../resource/images/eorder/panel/hd2.gif" bgcolor="#000066" class="TBHead"><?=$uplotype?> : Repair</td>
        <td width="11" height="25" align="center" class="TBHead"><img src="../resource/images/eorder/panel/hd3.gif" alt="" width="11" height="25" /></td>
      </tr>
    </table>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
...
VerifyRemoveDetailDisplay("<?=$uplotype?>");
</script>