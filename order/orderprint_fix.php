        ...
        <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td align="left"><?=$data_eorder->Rs("ord_inputdated");?>
                    ...
                    <?=$data_eorder->Rs("ord_inputdateh");?>:<?=$data_eorder->Rs("ord_inputdatemn");?></td>
          </tr>
          <tr>
...
<td align="left"><strong>
      ...
      <? if($ordfobservation!=''){ ?>
      <tr>
        <td colspan="2"><pre><?=$ordfobservation?>
</pre></td>
      </tr>
      <? } ?>
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class="print"><span class="style1">
...
width="100%">
  ...
  <td><pre><?=$ordfobservation?></pre></td></tr-->
    ...
    <td align="center" valign="top"><table width="350" border="0" cellpadding="2" cellspacing="0" class="print">
      <tr>
        <td colspan="2" align="left" valign="top"><table width="100%" cellpadding="0" cellspacing="0">
            <tr height="20">
...
width="100%">
              <tr>
                <td><table cellspacing="0" cellpadding="1">
                    <tr>
                      <td colspan="4" class="HI"><strong>Enclosed / สิ่งที่ส่งมาด้วย</strong></td>
                    </tr>
                    <tr>
                      <td align="left" valign="top"><input type="checkbox" name="checkbox" id="checkbox" /></td>
                      <td align="left" valign="top">Tray</td>
                      <td align="left" valign="top"><input type="checkbox" name="checkbox" id="checkbox" />
                      บน</td>
                    ...
                    <tr>
                      <td align="left" valign="top"><input type="checkbox" name="checkbox" id="checkbox" /></td>
                      <td align="left" valign="top">Special Tray</td>
                      <td><input type="checkbox" name="checkbox" id="checkbox" />
                        บน</td>
                      <td align="left" valign="top"><input type="checkbox" name="checkbox" id="checkbox" />
                      ล่าง</td>
                    ...
                    <tr>
                      <td align="left" valign="top"><input type="checkbox" name="checkbox" id="checkbox" /></td>
                      <td colspan="3" align="left" valign="top">Bite-Silicone</td>
                    </tr>
                    <tr>
                      <td align="left" valign="top"><input type="checkbox" name="checkbox" id="checkbox" /></td>
                      <td colspan="3" align="left" valign="top">Bite-Wax</td>
                    </tr>
                    <tr>
                      <td align="left" valign="top"><input type="checkbox" name="checkbox" id="checkbox" /></td>
                      <td colspan="3" align="left" valign="top">Model บน</td>
                    </tr>
                    <tr>
                      <td align="left" valign="top"><input type="checkbox" name="checkbox" id="checkbox" /></td>
                      <td colspan="3" align="left" valign="top">Model ล่าง</td>
                    </tr>
                    <tr>
                      <td colspan="4" align="left">Order_____________________Box____________</td>
                    </tr>
                    <tr>
                      <td colspan="4" align="left">หมายเหตุ ________________________________</td>
                    </tr>
                    <tr>
                      <td colspan="4" align="left">ผู้ตรวจสอบ _______________________________</td>
                    </tr>
                </table></td>
              </tr>
            </table>          </td>
  ...
  <? if($ordtypeF){?>
  <tr>
    <td height="300" colspan="2" align="left" valign="bottom"  bgcolor="#FFFFFF"><br />
...
<? 
  ...
  <tr bgcolor="#FFFFFF" height="20">
    ...
    </table>    QF02-009 ( 20/05/2552 ครั้งที่แก้ไข : 0 )<br />
