...
<tr><td height="50"><?  $currentMenu="releaseorder";include_once("../report/reportmenu.php"); ?></td></tr>
<tr><td align="center" valign="top">
<table border="0" cellspacing="0" cellpadding="4">


<form name="FormOrderExportList" action="orderexportlist_c.php" method="get" target="popUpWin">
<input type="hidden" name="searchtype" value="date">
  <tr>
	...
	?></td>
    <td width="70"><input type="button" class="BTok" value="SUBMIT" onClick=" popUpWindow('', 100, 100, 800, 600);FormOrderExportList.submit()" ></td>
  </tr>
  <tr>
...
<?  $i=0;$column=5;while(!$data_eorder->EOF){ 
	$cdate 		= substr($data_eorder->Rs("releasedate"),8,2);
	$cmonth 	= substr($data_eorder->Rs("releasedate"),5,2);
	$cyear 		= substr($data_eorder->Rs("releasedate"),0,4)+543;

?>
  
    <td align="center" bgcolor="#FFFFFF">
    <a href="#" onClick="popUpWindow('../order/orderexportlist_expire.php?edate=<?= $data_eorder->Rs("releasedate")?>', 100, 100, 800, 600);">
