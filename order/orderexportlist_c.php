...
//-----------------------------------------------------------------------------------------------------------------------------------	
	...
	if($searchtype=="date"){
		...
		//$query .= " left join	(select eorder_fixid,ordf_alloy from eorder_fix)as efix on eordertodayid = eorder_fixid ";
		/*$query .= " 
		...
		$query  .= " and (DATE(ordt_releasedate) between '$cyear-$cmonth-$cdate' 
