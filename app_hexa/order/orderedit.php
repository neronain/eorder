  ...
  <td bgcolor="#DDDDFF"><table border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td><table width="100%" border="0" cellpadding="2" cellspacing="0" class="Normal">
		  ...
		  <tr>
            <td align="right">
              <input name="ordfalloy" type="radio" value="7" <?=$ordfalloy=='8'?"checked":""?>>            </td>
            <td>Precious - High Yellow - Gold</td>
          </tr>
      </table></td>
    </tr>
  </table></td>
...
Pontic buccal , palatal smaller<br>
...
New Dentist<br>
<input name="ordfoptmoreinfo[]" type="checkbox" value="ChangeShade"  
<?=in_array('ChangeShade', $ordfoptmoreinfo)?"checked":""?>> 
Pink Porcelain<br>
...
<?=in_array('WrongBite', $ordfoptremark)?"checked":""?>>
    Wrong bite</td>
	<input type="checkbox" name="ordfoptremark[]" value="WrongBite2"  
<?=in_array('WrongBite2', $ordfoptremark)?"checked":""?>>
    Wrong bite2</td>
