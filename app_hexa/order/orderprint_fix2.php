...
<td align="left"><strong>
      ...
      <tr>
        <td colspan="2" align="left"><? if($ordtypeF){?>
              ...
              <table border="0" cellpadding="2" cellspacing="0" class="print" width="100%">
                <tr>
...
//	  var_dump($fix_bridgereduce);
  ...
  $margintext = "Lingual Metal margin 0.5 mm : ". $marginvalue;
    ...
    if($marginvalue!=""){  ?>
                ...
                <? } ?>
                <?  
  $marginvalue = getParameter($fix_prefix,"MGDM");
  $margintext = "Lingual Mistal & Distal margin : ". $marginvalue;
    ...
    if($marginvalue!=""){  ?>
                ...
                <? } ?>
                <?  
  $marginvalue = getParameter($fix_prefix,"MGPD");
  $margintext = "Pindex : ". $marginvalue;
    ...
    if($marginvalue!=""){  ?>
                ...
                <? } ?>
                <?  
  $marginvalue = getParameter($fix_prefix,"MGDH");
  $margintext = "เจาะรู / Drilling Hold : ". $marginvalue;
...
width="100%">
                        <tr>
                          <td align="left" valign="top"><strong>Additional Info</strong><br />
							  ...
							  <?=in_array('ShortMargin', $ordfoptremark)?"-High Esthetic<br>":""?>
                              <?=in_array('AddContactPoint', $ordfoptremark)?"-Casting Abutment (UCLA)<br>":""?>
                              <?=in_array('RepairCeramic', $ordfoptremark)?"-Abutment From Doctor<br>":""?>
                              <?=in_array('CeramicCracked', $ordfoptremark)?"-Abutment From Hexa<br>":""?>
                              <?=in_array('CanNotInsert', $ordfoptremark)?"-Abutment From Atlantis<br>":""?>
                              <?=in_array('ChangeDesign', $ordfoptremark)?"-Soft Tissue by Hexa<br>":""?>
                              <?=in_array('WrongBite', $ordfoptremark)?"-Preparation Milling Abutment<br>":""?>
							  </td>
                        </tr>
                      </table>
                    <? } ?>                  </td>
