...
<table align="center" cellpadding="3" cellspacing="0" class="Normal">
  ...
  <tr>
    <td><label><input type="checkbox"  value="ChangeShade" onchange="setValue('fix_remake[ChangeShade]',this.checked+0);" <?=array_key_exists ('ChangeShade', $fix_remake)?" checked":" "?>/>
      Change shade</label><br />
