...
<table border="0" cellpadding="2" cellspacing="1" bgcolor="#999999">
  <tr>
    <td colspan="2" align="center" bgcolor="#CCCCCC"><strong>Doctor Add</strong></td>
  </tr>
  <tr>
    <td width="100" align="center" bgcolor="#FFFFFF"><strong>Doctor name</strong></td>
    <td bgcolor="#FFFFFF"><input id="docname" type="text" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2" align="right" bgcolor="#E5E5E5"><input type="button" value="Add" onClick="showHTML('DivComboDoctor','../eorder/doctor_process.php?act=eorder&cid=<?=$customer_id?>&name='+encodeTH(getValue('docname'))+'&did=-1');" />
      &nbsp;
