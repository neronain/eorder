            ...
            <td colspan="2">
                ...
                <table width="100%" border="0" cellspacing="1" align="center">
                    ...
                    <tr>
                        <td >Type</td>
                        <td align="right">
                            <input type="radio" name="sec_type" value="F" <?=$sec_type=='F'?'checked="checked"':''?> />Fix
                            <input type="radio" name="sec_type" value="R" <?=$sec_type=='R'?'checked="checked"':''?> />Remove
                            <input type="radio" name="sec_type" value="O" <?=$sec_type=='O'?'checked="checked"':''?> />Ortho
                            <input type="radio" name="sec_type" value="M" <?=$sec_type=='M'?'checked="checked"':''?> />Manager
                    ...
                    <tr>
                            ...
                            <table border="0" cellpadding="2" cellspacing="1" bgcolor="#000000">
                                <tr>
                                    <td width="50" align="center" bgcolor="#FFFFFF" class="tdButtonOnOut"
                                        onclick="formSectionEdit.submit();" onmouseover="this.className='tdButtonOnOver'"
                        ...
                        <td width="50">
                            <table border="0" cellpadding="2" cellspacing="1" bgcolor="#000000">
                                <tr>
                                    <td width="50" align="center" bgcolor="#FFFFFF" class="tdButtonOnOut"
                                        onclick="CloseDivEditSectionData();" onmouseover="this.className='tdButtonOnOver'"
